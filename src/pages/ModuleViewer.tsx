        ...
        if (data && data.curriculum_data) {
          ...
          if (moduleId) {
            ...
            if (moduleIndex >= 0) {
              ...
              console.log('ModuleViewer: 拡張されたモジュール情報を設定:', enhancedModule);
            } else {
  ...
  const generateModuleContent = async () => {
    ...
    try {
      ...
      if (user) {
        ...
        console.log('ModuleViewer: ユーザープロファイルデータ:', userProfileData ? '取得成功' : '未取得');
      }
      ...
      const generatePromise = generateModuleDetail(
        ...
        { 
          ...
          userProfile: userProfileData // ユーザープロファイル情報を追加
        }
      );
