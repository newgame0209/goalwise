      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">goalwise</h3>
            <p className="text-sm text-muted-foreground">
              AIを活用した個別最適化学習で、あなたの目標達成をサポートします。
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <NavLink to="/materials" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  教材一覧
                </NavLink>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <NavLink to="/careers" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  採用情報
                </NavLink>
              </li>
            </ul>
        ...
        <div className="border-t border-border/50 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} goalwise. All rights reserved.
          </p>
